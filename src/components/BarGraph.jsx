...
const jb_url = 'https://bankkie-555.netlify.app/api/bar/job/balances';
const mb_url = 'https://bankkie-555.netlify.app/api/bar/marital/balances';
...
export default function BarGraph() {
    ...
    async function fetchDrilldown(a_job) {
        setLoading(true);
        try {
            const response3 = await axios.get(`https://bankkie-555.netlify.app/api/bar/drilldown/${a_job}`);
